...
export class FundtransferComponent implements OnInit {
  ...
  constructor(private customerService : UserService, private statementservice:TransactionService) { }
  ...
  updateFromCustomer(fromId: any, resp : User){
  ...
  updateToCustomer(toID : any, resp : User){
